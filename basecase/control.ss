...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
  ...
  0         1           0.53           0.2           0.8             0         -4          0          0          0          0          0          0          0 # SR_sigmaR
...
2005.7   #_last_early_yr_nobias_adj_in_MPD 
2009.9   #_first_yr_fullbias_adj_in_MPD 
2023.7   #_last_yr_fullbias_adj_in_MPD 
2023.9   #_first_recent_yr_nobias_adj_in_MPD 
0.9115  #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models) 
...
#_ LO HI INIT PRIOR PR_SD  PR_type  PHASE
0.005 0.5 0.1 0.05 0.8 0 3 # InitF_seas_1_flt_1FISHERY
#
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
-15  1  0	0	99	0	3	0	0	0	0	0	0	0 #  LnQ_base_COMERCIAL(1)
-15  0 -3	0	99	0	3	0	0	0	0	0	0	0  #  LnQ_base_POBLACIONAL(2)
...
#_Factor  Fleet  Value
4   1    2.13464  # COMERCIAL
4   2    6.19332  # POBLACIONAL
 -9999   1    0  # terminator
#
4 #_maxlambdaphase
