...
0	3	0.0003	0.0003	99	0	-5	0	0	0	0	0	0	0 # Wtlen_1_Fem_GP_1			
0	6	2.68	2.68	99	0	-5	0	0	0	0	0	0	0 # Wtlen_2_Fem_GP_1			
# Sex: 1  BioPattern: 1  Maturity&Fecundity																
0	3	1.04	1.04	1	0	-5	0	0	0	0	0	0	0	 # Mat50%_Fem_GP_1		
-3	3	-1.7	-1.7	0	0	-3	0	0	0	0	0	0	0	#	Mat_slope_Fem_GP_1	
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
  3            30       15          15            15             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
...
#_ LO HI INIT PRIOR PR_SD  PR_type  PHASE
0.005 0.1 0.1 0.05 0.8 0 3 # InitF_seas_1_flt_1FISHERY
#
...
1         1         0         0         0         0  # COMERCIAL
2         1         0         0         0         0  # POBLACIONAL
-9999 0 0 0 0 0
#
#_Q_parms(if_any);Qunits_are_ln(q)
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
-5 0 -3	0	99	0	4	0	0	0	0	0	0	0 #  LnQ_base_COMERCIAL(1)
-5 0 -3	0	99	0	4	0	0	0	0	0	0	0  #  LnQ_base_POBLACIONAL(2)
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
# 1 FISHERY LenSelex
0.02            4      2.2             2.2           0.5             0          -4          0          0          0          0          0          0          0  #SizeSel p1 COMERCIAL(1)
0.01          4       0.15             0.15           0.5             0          -4          0          0          0          0          0          0          0  #  #SizeSel p2 COMERCIAL(1)
...
# 1 FISHERY LenSelex
  ...
  0.01          3       0.5             0.5           0.5             0          2          0          0          0          0          0          0          0  #  #SizeSel p1 POBLACIONAL(2)
