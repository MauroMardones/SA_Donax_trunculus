...
```{r ssb, echo=FALSE, fig.align='center', out.width = "80%", fig.cap="\\label{fig:ssb}Total biomass with forecast to coquina"}
SSplotTimeseries(base.model1,
                 subplot = 7)
```


```{r ssb1, echo=FALSE, fig.align='center', out.width = "80%", fig.cap="\\label{fig:ssb1}Spawning output with forecast with 95% asymptotic intervals and relative spawining biomass to coquina"}
SSplotTimeseries(base.model1,
                 subplot = 9)
```
