...
```{r bio, echo=FALSE, out.width = "80%", fig.align='center', fig.cap="\\label{fig:bio}Función de crecimiento asumida en el modelo. El área sombreada indica una distribución del 95% de la talla por edad alrededor de la curva de crecimiento estimada y Ojiva de madurez por talla para coquina"}
...
```{r sel, echo=FALSE, out.width = "80%", fig.align='center', fig.cap="\\label{fig:sel}selectivity at length in end year for all fleets shown together para coquina"}
...
```{r lenfit, echo=FALSE,fig.keep='all', fig.show="hold", fig.cap="\\label{fig:lenfit}Fit length compositions"}
par(mfrow=c(3,3), mar=c(1.5,5,3,2) + 0.1)
...
```{r lenfit2, echo=FALSE,fig.keep='all', fig.show="hold", out.width="80%", fig.cap="\\label{fig:lenfit2}Spawning output with forecast with ~95% asymptotic intervals and relative spawining biomass to coquina"}
SSplotComps(base.model1,
            subplots = 5)
SSplotComps(base.model1,
            subplots = 8)
...
```{r ssb, echo=FALSE,fig.keep='all', fig.show="hold", out.width="80%", fig.cap="\\label{fig:ssb}Spawning output with forecast with ~95% asymptotic intervals and relative spawining biomass to coquina"}
