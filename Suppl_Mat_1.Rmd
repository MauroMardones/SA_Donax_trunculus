...
replist <- SS_output(dir=dir3,verbose=TRUE,printstats=TRUE)
summary <- read.table(here(dir3,
                           "ss_summary.sso"),
                      header=F,sep="",
                      na="NA",fill=T) 
...
df_all <- bind_rows(
  create_heatmap_df(base.model1$lendbase, "s1: 23 cm MLS"),
  create_heatmap_df(base.model2$lendbase, "s2: 24 cm MLS"),
  create_heatmap_df(base.model3$lendbase, "s3: 25 cm MLS (Ref Model)"),
