...
dirb     <- here::here("EM","basecase")        # Initial model (2.2 MLS fixed)
dir0    <- here::here("EM","s0")        # Scenario 2.2 (MLS fixed)
dir1     <- here::here("EM","s1")        # Reference model (2.3 MLS fixed)
# Alternative management scenarios
dir2 <- here::here("EM","s2")       # Scenario 2.4 (MLS fixed)
dir3 <- here::here("EM","s3")       # Scenario 2.5 (MLS fixed) (current MLS)
dir4 <- here::here("EM","s4")       # Scenario 2.6 (MLS fixed)
# # Simulated mean-based models
dir2.3 <- here::here("EM","s1_2.3")      # Simulated model: 2.3 mean MLS
...
# Modelo de referencia (s3 = MLS 25 mm)
...
# Tabla
kbl(res_wide,
    caption = "Summary of key population metrics across MLS scenarios",
    digits  = 2,
